...
define(['mediator', 'lib/utils', 'controllers/base/controller', 'models/user', 'lib/services/facebook', 'views/login_view'], function(mediator, utils, Controller, User, Facebook, LoginView) {
  'use strict';
