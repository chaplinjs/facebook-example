...
define(['chaplin', 'views/base/collection_view', 'views/post_view', 'text!templates/posts.hbs'], function(Chaplin, CollectionView, PostView, template) {
  'use strict';
  ...
  return PostsView = (function(_super) {
    ...
    PostsView.prototype.container = '#content-container';
