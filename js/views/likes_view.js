...
define(['chaplin', 'views/base/collection_view', 'views/compact_like_view', 'text!templates/likes.hbs'], function(Chaplin, CollectionView, CompactLikeView, template) {
  'use strict';
  ...
  return LikesView = (function(_super) {
    ...
    LikesView.prototype.container = '#content-container';
    ...
    LikesView.prototype.showHideLoginNote = function() {
      return this.$('.login-note').css('display', Chaplin.mediator.user ? 'none' : 'block');
    };
